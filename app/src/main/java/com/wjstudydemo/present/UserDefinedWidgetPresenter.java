...
import com.wjstudydemo.view.UserDefinedWidgetActivity;
 ...
 **/
public class UserDefinedWidgetPresenter extends BasePresenter<UserDefinedWidgetActivity> {
    ...
    @Override
    protected void onTakeView(UserDefinedWidgetActivity activity) {
        super.onTakeView(activity);
        String json = "[{\"studyName\":\"学习画笔\",\"studyClassName\":\"com.wjstudydemo.view.userDefinedWidget.DrawDemo1Activity\"}," +
